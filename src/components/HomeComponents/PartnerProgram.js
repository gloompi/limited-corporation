    ...
    <section className={`${style.section} ${style.partner__wrap}`}>
      <div className={`${style.container} ${style.section__container}`}>
        ...
        <div className={style.partner__descr}>
          <p>Дополнительным заработком на платформе является 3-х-уровневая партнерская программа. Приглашая новых участников, зарабатывайте минимум 5% от их вкладов. При правильном подходе - это отличная возможность получать пассивную прибыль не вкладывая собственные средства.</p>
        </div>
